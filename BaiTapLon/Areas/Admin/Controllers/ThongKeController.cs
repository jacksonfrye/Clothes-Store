...
namespace BaiTapLon.Areas.Admin.Controllers
{
    public class ThongKeController : BaseController
    {
        ...
        public ActionResult ExportExel(string fromDate, string toDate)
        {
            ...
            var wb = new XLWorkbook(@"D:\Code\DotNet\ClothesWebDotNet6\ClothesStore\BaiTapLon\Resource\Template\Doanh_Thu_Template.xlsx");
            ...
            if (!string.IsNullOrEmpty(fromDate) || !string.IsNullOrEmpty(toDate))
            {
                nameFile = "Doanh_Thu_Tu_" + fromDate + "_" + toDate + "_" + DateTime.Now.Ticks + ".xlsx";
            }
            else
            {
                nameFile = "Doanh_Thu_Ca_Nam" + "_" + DateTime.Now.Ticks + ".xlsx";
            }
