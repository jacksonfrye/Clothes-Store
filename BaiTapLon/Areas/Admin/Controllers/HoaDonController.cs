...
namespace BaiTapLon.Areas.Admin.Controllers
{
    public class HoaDonController : BaseController
    {
        ...
        public ActionResult ExportExel(long id)
        {
            ...
            var wb = new XLWorkbook(@"D:\Code\DotNet\ClothesWebDotNet6\ClothesStore\BaiTapLon\Resource\Template\Hoa_Don_Template.xlsx");
            ...
            string nameFile = "Details_Order_" + list[0].OderID + "_" + DateTime.Now.Ticks + ".xlsx";
