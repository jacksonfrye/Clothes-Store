...
namespace BaiTapLon.Areas.Admin.Controllers
{
    public class SanPhamController : BaseController
    {
        ...
        {
            var wb = new XLWorkbook(@"D:\Code\DotNet\ClothesWebDotNet6\ClothesStore\BaiTapLon\Resource\Template\Kho_Hang_Template.xlsx");
            ...
            {
                nameFile = "Kho_Hang_Tu_" + fromDate + "_" + toDate + "_" + DateTime.Now.Ticks + ".xlsx";
            }
            else
            {
                nameFile = "Tat_Ca_Kho_Hang" + "_" + DateTime.Now.Ticks + ".xlsx";
            }
