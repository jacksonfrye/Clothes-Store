...
namespace BaiTapLon.Areas.Admin.Controllers
{
    public class NhapHangController : BaseController
    {
        ...
        {           
            var wb = new XLWorkbook(@"D:\Code\DotNet\ClothesWebDotNet6\ClothesStore\BaiTapLon\Resource\Template\Nhap_Hang_Template.xlsx");
            ...
            string nameFile = "Phieu_Nhap_Hang_" + list.IDNhapHang + "_" + DateTime.Now.Ticks + ".xlsx";
